...
import de.ahbnr.semanticweb.sjdb.rdf.mapping.forward.utils.TripleCollector
import de.ahbnr.semanticweb.sjdb.rdf.mapping.forward.utils.ValueToNodeMapper
import de.ahbnr.semanticweb.sjdb.rdf.mapping.forward.utils.extendsClass
import de.ahbnr.semanticweb.sjdb.rdf.mapping.forward.utils.implementsInterface
    ...
    private class Graph(
        ...
        override fun graphBaseFind(triplePattern: Triple): ExtendedIterator<Triple> {
            ...
            fun addReferenceOrNullClass(referenceTypeURI: String) =
                de.ahbnr.semanticweb.sjdb.rdf.mapping.forward.utils.addReferenceOrNullClass(
                    referenceTypeURI,
                    tripleCollector,
                    URIs
                )
